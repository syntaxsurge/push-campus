...
const catalog: CourseCatalogItem[] = [
  {
    ...
    tags: ['Solidity', 'Push Chain', 'Tooling'],
    summary:
      'Hands-on introduction to Solidity, Hardhat, and secure smart-contract patterns for Push Chain builders.'
  },
  {
    courseId: 2n,
    ...
    summary:
      'Blueprint and templates for crafting recurring-revenue membership products with PushCampus infrastructure.'
  },
  {
    courseId: 3n,
